            ...
            <div class="flex">
                ...
                <div class="ml-3">
                    ...
                    <div class="mt-2 text-sm text-danger-700 dark:text-danger-900">
                        <p>
                            Você está prestes a excluir permanentemente esta organização. 
                            Esta ação <strong class="dark:text-danger-400">não pode ser desfeita</strong> e todos os dados 
                            associados à organização serão removidos completamente do sistema.
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class="bg-white dark:bg-gray-800 shadow rounded-lg">
            <div class="px-4 py-5 sm:p-6">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">Slug: {{ $this->getRecord()?->slug ?? 'N/A' }}</label>
                    </div>
                    
                    <div>
                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">Membros: {{ $this->getRecord()?->users()->count() ?? 0 }}</label>
                    </div>
