            ...
            @if($hasChildren)
                ...
                >
                    @if($this->isFolderExpanded($folderId))
                        <x-heroicon-o-chevron-down class="w-3 h-3 text-gray-500" />
                    @else
                        <x-heroicon-o-chevron-right class="w-3 h-3 text-gray-500" />
                    @endif
                </button>
            @else
                ...
                @if(!$isReadOnly)
                    ...
                    >
                        ...
                        <button
                            ...
                            title="Move"
                        >
                            <x-heroicon-o-arrow-right-circle class="w-3 h-3" />
                        </button>
                    </div>
                @endif
            </div>
