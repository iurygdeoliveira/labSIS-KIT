...
describe('Acesso aos Painéis', function () {
    it('redireciona visitantes para o login ao tentar acessar painéis protegidos', function () {
        /** @var \Tests\TestCase $this */
        $this->get('/admin')->assertRedirect('/__compat-login');
        $this->get('/user')->assertRedirect('/__compat-login');
    });

    it('usuário admin pode acessar o painel administrativo', function () {
        /** @var \Tests\TestCase $this */
    ...
    it('usuário admin é redirecionado para /admin ao acessar a página de login', function () {
        /** @var \Tests\TestCase $this */
        $admin = User::where('email', 'admin@labsis.dev.br')->firstOrFail();
    ...
    it('usuário comum não pode acessar o painel administrativo', function () {
        /** @var \Tests\TestCase $this */
    ...
    it('usuário comum com tenant pode acessar o painel do usuário diretamente', function () {
        /** @var \Tests\TestCase $this */
    ...
    it('usuário comum é redirecionado para o painel do tenant ao acessar a página de login', function () {
        /** @var \Tests\TestCase $this */
